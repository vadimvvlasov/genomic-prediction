...
test_that("fn_prediction_performance_metrics", {
    ...
    expect_equal(list_metrics_1, list(mbe=0, mae=0, rmse=0, r2=1, corr=1, corr_rank=1, power_t10=1, power_b10=1, var_additive=841.666666666666, var_residual=0.0, h2=1))
    expect_equal(list_metrics_2, list(mbe=-pi, mae=pi, rmse=pi, r2=(1-(n*(pi^2)/sum((y_true-mean(y_true))^2))), corr=1, corr_rank=1, power_t10=1, power_b10=1, var_additive=841.666666666666, var_residual=0.0, h2=1))
    ...
    expect_equal(is.na(list_metrics_4$corr_rank), TRUE)
