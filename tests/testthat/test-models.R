...
test_that("fn_Bayes_A", {
    ...
    expect_equal(sum(list_Bayes_A$vec_effects != 0.0) < 1+ncol(G), TRUE)
    expect_equal(list_Bayes_A$n_non_zero < ncol(G), TRUE)
})
...
test_that("fn_Bayes_B", {
    ...
    expect_equal(sum(list_Bayes_B$vec_effects != 0.0) < 1+ncol(G), TRUE)
    expect_equal(list_Bayes_B$n_non_zero < ncol(G), TRUE)
})
...
test_that("fn_Bayes_C", {
    ...
    expect_equal(sum(list_Bayes_C$vec_effects != 0.0) < 1+ncol(G), TRUE)
    expect_equal(list_Bayes_C$n_non_zero < ncol(G), TRUE)
})
