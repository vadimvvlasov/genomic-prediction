...
test_that("fn_cross_validation_within_population", {
    ...
    expect_equal(sum(dim(list_within$METRICS_WITHIN_POP) == c(3*2*1*2, 17)), 2)
...
test_that("fn_cross_validation_across_populations_bulk", {
    ...
    expect_equal(sum(dim(list_across_bulk$METRICS_ACROSS_POP_BULK) == c(1*2*1*2, 17)), 2)
...
test_that("fn_cross_validation_across_populations_pairwise", {
    ...
    expect_equal(sum(dim(list_across_pairwise$METRICS_ACROSS_POP_PAIRWISE) == c((3*(3-1))*1*2, 17)), 2)
...
test_that("fn_cross_validation_across_populations_lopo", {
    ...
    expect_equal(sum(dim(list_across_lopo$METRICS_ACROSS_POP_LOPO) == c(3*1*2, 17)), 2)
