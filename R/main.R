...
gp = function(args) {
    ...
    #     population="pop_1",
    # args = list(
    #     fname_geno="/group/pasture/Jeff/lucerne/workdir/training_size_optim/geno.Rds",
    #     fname_pheno="/group/pasture/Jeff/lucerne/workdir/training_size_optim/pheno.tsv",
