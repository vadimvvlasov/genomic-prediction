...
GENOTYPE_DATA_RDS='/group/pasture/Jeff/gp/inst/exec_Rscript/tests/grape.Rds'
...
PHENOTYPE_DATA_TSV='/group/pasture/Jeff/gp/inst/exec_Rscript/tests/grape_pheno.tsv'
