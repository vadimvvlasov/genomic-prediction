# devtools::load_all()
library(gp)
suppressPackageStartupMessages(library(sommer)) ### We need to explicitly load the sommer package for gBLUP model because of some scoping mechanism I am not entirely familiar with
...
args$pheno_vec_na_strings = unlist(strsplit(gsub(" ", "", args$pheno_vec_na_strings), ","))
print(args)
### Run
